...
public class OdometryGlobalCoordinatePosition implements Runnable{
    ...
    private double robotGlobalXCoordinatePosition = 0, robotGlobalYCoordinatePosition = 0, robotOrientationRadians = 0, robotOrientationDegrees = 0, travelDistance = 0, radius = 0, averageRadius = 0;
    ...
    private void globalCoordinatePositionUpdate(){
        ...
        //Calculate Angle
        //changeInRobotOrientation = (360*(rightChange-leftChange))/2*Math.PI *robotEncoderWheelDistance;
        changeInRobotOrientation = (leftChange - rightChange) / (robotEncoderWheelDistance);
        robotOrientationRadians = ((robotOrientationRadians + changeInRobotOrientation));
        //robotOrientationDegrees = ((robotOrientationDegrees + changeInRobotOrientation));
        ...
        //radius = (360*((verticalLeftEncoderWheelPosition-verticalRightEncoderWheelPosition)/2)/(2*Math.PI*robotOrientationDegrees);
        //travelDistance = 2*Math.PI*(robotOrientationDegrees/360)*radius;
        //robotGlobalXCoordinatePosition = radius * p * Math.grad(fa*n)-(travelDistance * Math.grad(q*2*Math.PI))
        //robotGlobalYCoordinatePosition = radius
